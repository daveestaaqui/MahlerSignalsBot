...
Nothing on the Aurora-Signals platform constitutes, or is meant to constitute, a recommendation, endorsement, or solicitation to buy or sell any securities, cryptocurrencies, or other financial instruments. Past performance of any algorithm or signal does not guarantee future results.

## No Warranty
Aurora-Signals is provided “as is” without any representations or warranties, express or implied. While we strive for accuracy and uptime, we do not warrant that the information on this platform is complete, true, accurate, non-misleading, or always available.

## Limitation of Liability
To the maximum extent permitted by law, Aurora-Signals, its maintainers, and contributors will not be liable for any direct, indirect, incidental, consequential, or punitive damages arising from your use of the service.
